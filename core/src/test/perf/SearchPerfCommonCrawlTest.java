...
public class SearchPerfCommonCrawlTest {
  ...
  private static void _main(String[] clArgs) throws Exception {
    ...
    final String perfCommand = args.getString("-perf");
    ...
    // "body" -> "content"
    final QueryParser queryParser = new QueryParser(fieldName, a);
    ...
    if (tasksFile.startsWith("server:")) {
      ...
      tasks = new LocalTaskSource(indexState, taskParser, tasksFile, staticRandom, random, numTaskPerCat, taskRepeatCount, doPKLookup, false, logFile, perfCommand);
