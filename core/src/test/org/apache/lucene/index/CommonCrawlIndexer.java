...
public class CommonCrawlIndexer {
    ...
    public static void main(String args[]) throws Exception {
        ...
        final String[] watFileList = docsDirFile.list((current, name) -> new File(current, name).isDirectory());
        ...
        exec.shutdown();
        System.out.println(IndexerThread.datasetSize.get() / 1000 + "kb is the total English raw text data size used");
