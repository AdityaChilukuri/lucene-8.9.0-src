    ...
    public LeafCollector getLeafCollector(LeafReaderContext context) throws IOException {
      ...
      return new ScorerLeafCollector() {
        ...
        public void collect(int doc) throws IOException {
          ...
          pqTop.score = score;
          pqTop = pq.updateTop(); // Adi: This notation allows a priority queue of ScoreDoc objects to be updated to reflect the top N docs in the posting list without creating objects in this hot code
          updateMinCompetitiveScore(scorer);
        }
