  ...
  private final static class HighFreqDocsEnum extends PostingsEnum {
    ...
    public int advance(int target) {
      ...
      */
      ...
      while (true) { // Adi: This is unnecessary of we literally always want the next doc.
                     // Adi: But might not be an issue if memory bandwidth is always the problem. This loop only executes ~4 times per document in the posting list
        if (low > high) {
          // Not exactly found
